    ...
    <div className="bg-bg text-text font-[var(--font-geist-sans)] min-h-screen">
      ...
      <article className="px-8 md:px-16 pt-40 pb-32">
        <div className="max-w-screen-xl mx-auto">
          ...
          <Link
            href="/insights"
            className="inline-flex items-center gap-2 text-[0.55rem] tracking-[0.25em] uppercase text-text-muted hover:text-text-muted transition-colors mb-16"
          >
          ...
          {/* Divider */}
          <div className="max-w-3xl mb-16" style={{ borderTop: "1px solid rgb(var(--hairline) / 0.06)" }} />
          ...
          {/* CTA */}
          <div className="max-w-3xl mt-24 pt-16" style={{ borderTop: "1px solid rgb(var(--hairline) / 0.06)" }}>
            <p className="text-[0.55rem] tracking-[0.3em] uppercase text-accent mb-6">
              {t("다음 단계", "Next Step")}
            </p>
            <p className="text-text-muted text-sm leading-[1.9] font-light mb-8 max-w-lg">
              {t(
